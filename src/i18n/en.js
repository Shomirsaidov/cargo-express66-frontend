export default {
  ...
  auth: {
    ...
    forgotPasswordDescription: 'Enter your email and we will send you a one-time verification code.',
    sendCode: 'Send code',
    ...
    waitBeforeResend: 'Please wait before requesting another code.',
