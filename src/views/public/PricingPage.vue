      ...
      <div class="space-y-6">
        <div class="card p-6 border border-gray-150">
          <div class="flex gap-4">
            ...
            <div>
              <h3 class="font-bold text-lg text-gray-900 mb-2">Правила расчёта веса</h3>
              <p class="text-sm text-gray-600 leading-relaxed mb-2">
                • Расчёт стоимости доставки ведётся <strong>строго по граммам</strong> без минимального порога в 1 кг. Например, если товар весит 0.25 кг (250 грамм), вы платите ровно за 250 грамм.
              </p>
              <p class="text-sm text-gray-600 leading-relaxed">
                • Для оптовых партий от 100 кг и от 1000 кг действуют сниженные базовые тарифы.
              </p>
            </div>
          </div>
        </div>
